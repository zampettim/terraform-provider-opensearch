...
func resourceOpenSearchAuditConfig() *schema.Resource {
	return &schema.Resource{
		Create: resourceOpensearchAuditConfigCreate,
		Read:   resourceOpensearchAuditConfigRead,
		Update: resourceOpensearchAuditConfigUpdate,
		Delete: resourceOpensearchAuditConfigDelete,
...
func resourceOpensearchAuditConfigCreate(d *schema.ResourceData, m interface{}) error {
	...
	return resourceOpensearchAuditConfigRead(d, m)
}
...
func resourceOpensearchPutAuditConfig(d *schema.ResourceData, m interface{}) (*putAuditConfigResponse, error) {
